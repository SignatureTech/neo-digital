...
const AboutUs = () => {
    return (
        <div className="bg-black">
            <section className="container m-auto text-white py-10 px-6 md:px-12">
            ...
            <section className="container m-auto text-center py-10 relative">
                <div className="absolute inset-0 bg-[url('/stars-space.jpg')] bg-cover bg-center opacity-20"></div>

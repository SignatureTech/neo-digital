...
const Services = () => {
    ...
    return (
        <div className="bg-black">
            <section className="container mx-auto py-12 px-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10">
                    {servicesData.map((service) => (
                        <div
                            key={service.id}
                            className="bg-gray-100 p-6 rounded-xl text-black shadow-md transform transition duration-500 ease-in-out hover:scale-105 animate-fade-in-up cursor-pointer"
                            onClick={() => {
            ...
            <section className="relative bg-[url(/images/about-count-img.jpg)] bg-cover bg-center bg-no-repeat py-16 px-6 md:px-12">
            ...
            <section className="container mx-auto text-center py-16 relative">

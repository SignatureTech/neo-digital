        ...
        <footer className="container m-auto text-white py-4">
          <div className="mx-auto flex flex-col md:flex-row justify-between px-6">
            <div className="text-center md:text-left mb-6 md:mb-0">
              <Link href={"/"}>
                <h2 className="text-2xl font-bold text-teal-400 inline">
                  NEO
            ...
            <div className="text-center md:text-left">
              ...
              <ul className="space-y-1">
                <li className="mb-2">
                  <a href="/contact-us" className="hover:text-teal-400">
                    Contact Us
                  </a>
                </li>
                <li className="mb-2">
          ...
          <div className="text-center text-sm text-gray-400 mt-6 border-t border-gray-700 pt-6">
            ©2025{" "}
            <span className="text-teal-400 font-semibold">NEO DIGITAL</span>.
            All rights reserved.
          </div>
        </footer>
      </div>
